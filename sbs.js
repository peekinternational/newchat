...
} else if (serverIpAdd.includes('192.168.1.10') || serverIpAdd.includes('127.0.0.1')) {
	keysOpt = {
		key: sslConfig.keyPl,
...
const corsOptions = {
	...
	origin: ["http://localhost:8080", "https://alllinkshare.com", "https://www.alllinkshare.com", "https://jobcallme.com", "https://www.bluefreelancer.com", "https://bluefreelancer.com", "https://www.jobcallme.com", "https://alswebcam.com", "https://www.alswebcam.com", "https://peekvideochat.com", "https://turn.peekvideochat.com", "192.168.10.1", "http://192.168.100.21:8080", "http://192.168.100.22:8080", "https://mediaserver.sintonus.com", "https://www.mooz.jp", "http://localhost:4200","https://peekhelpers.com/","https://www.peekhelpers.com/"], //the port my react app is running on. https://alllinkshare.com   / https://searchbysearch.com
...
io.on('connection', function (socket) {
	...
	//////// PeekHelppers Room send and receive msg ////////// 
	socket.on('roomMessage', (data) => {
		io.emit('roomreceivemsg', data);
	});
