    ...
    try {
      ...
      <div id="main-template-div" style="margin-top: -10px; margin-right: auto; margin-left: auto; width: 75%; background-color: white;">
          <div id="template-header">
              <img src="https://turn.peekvideochat.com:22000/images/chatto-logo.png" style="width: 75px; margin-left: 20px; margin-top: 8px">
          </div>
      
          <div id="template-body" style="text-align: center">
              <img src="https://turn.peekvideochat.com:22000/images/meeting-main-img.png" style="width: 75%; min-width: 250px">
