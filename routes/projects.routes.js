    ...
    newUserModel.save()
        .then(regUserData => {
            ...
            if (req.body.projectId == "5d4c07fb030f5d0600bf5c03") {
                ...
                projectLink = "https://www.alswebcam.com";
                projectName = "alswebcam";
                projectVerificationWay = 2;
            }

            else if (req.body.projectId == "5d4c07fb030f5d0600bf5c08") {
                projectLink = "https://mediaserver.sintonus.com";
                projectName = "sintonus";
                projectVerificationWay = 1;
            }
            ...
            if (result) {
                mailOptions = {
                    ...
                    html:
                        ...
                        `<br>Click here reset your password: <a href='https://turn.peekvideochat.com/login?token=${token}'>Reset</a></p>`
                };
            ...
            if (!result) {
                newUserModel.save().then(regUserData => {
                    ...
                    mailOptions = {
                        ...
                        text: 'peekvideochat',
                        html:
                            `<p><b>Dear, ${regUserData.name} </b> we are glad that you are now a part of peekvideochat group but before going to connect the world, 
                              we would like you to verify this email address by clicking below link` +
                            `<br>Click to verify: <a href='https://turn.peekvideochat.com/login?verifyid=${regUserData._id}'>Verify</a></p>`
                    };
