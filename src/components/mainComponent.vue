      ...
      <nav class="main-nav on custom-scroll" id="mainnav">
        ...
        <div class="sidebar-main">
          <ul class="sidebar-top">
            ...
            <li><a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="favourite()" id="Fav"><i class="fa fa-star">               </i></a></li>
            <li><a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="document()"> <i class="fa fa-file-text">       </i></a></li>
            <li><a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="contact()"> <i class="fa fa-users">  </i></a></li>
            <li>
              <div class="dot-btn dot-danger grow"><a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="notification()"> <i class="fa fa-bell"></i></a></div>
            </li>
            <li><a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="setting()" data-intro="You can change settings by clicking here"> <i class="fa fa-cog"></i></a></li>
          </ul>
          <ul class="sidebar-bottom">         
            <li><a class="icon-btn btn-light button-effect mode"  data-tippy-content="Theme Mode" data-intro="Change mode"><i class="fa fa-moon-o"></i></a></li>
            <li>
<button v-on:click="logout()" class="icon-btn btn-light"><i class="fa fa-power-off">  </i></button>
            </li>
          </ul>
        </div>
      </nav>
            ...
            <div class="theme-title">
              <div class="media">
                ...
                <div class="media-body">
                  <a class="icon-btn btn-outline-light button-effect pull-right mobile-back"  ><i class="ti-angle-right"></i></a>
          ...
          <div class="chat custom-scroll">
            <ul class="chat-cont-setting">
              ...
              <li><a href="#" data-toggle="modal" data-target="#msgcallModal"><span>new call</span>
                  <div class="icon-btn btn-outline-success button-effect btn-sm"><phone-icon size="1.5x" class="custom-class"></phone-icon></div></a></li>
              <li><a href="#" data-toggle="modal" data-target="#exampleModalCenter"><span>new Contact</span>
                  <div class="icon-btn btn-outline-danger button-effect btn-sm"><users-icon size="1.5x" class="custom-class"></users-icon></div></a></li>
            </ul>
            <div class="theme-title">
              <div class="media">
                <div> 
                ...
                <div class="media-body text-right">   <a class="icon-btn btn-outline-light btn-sm search contact-search" href="#"> <search-icon size="1.5x" class="custom-class"></search-icon></a>
                  <form class="form-inline search-form">
                    <div class="form-group">
                      <input class="form-control-plaintext" type="search" placeholder="Search.."/>
                      <div class="icon-close close-search">                 </div>
                    </div>
                  </form><a class="icon-btn btn-primary btn-fix chat-cont-toggle outside" href="#"><plus-icon size="1.5x" class="custom-class"></plus-icon></a>
                </div>
              </div>
            </div>
                ...
                <div class="tab-pane fade show active" id="chat" role="tabpanel" aria-labelledby="chat-tab"> 
                  <div class="theme-tab">       
                    <ul class="nav nav-tabs" id="myTab1" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link button-effect" @click="getgroups()" id="group-tab" data-toggle="tab" href="#group" role="tab" aria-controls="group" aria-selected="true" data-to="group_chat">Group</a></li>
                    </ul>
                ...
                <div class="tab-pane fade" id="call" role="tabpanel" aria-labelledby="call-tab"> 
                  <div class="theme-tab tab-icon">
                    <ul class="nav nav-tabs" id="contactTab" role="tablist">
                      ...
                      <li class="nav-item"><a class="nav-link" id="con3-tab" data-toggle="tab" href="#con3" role="tab" aria-controls="con3" aria-selected="false"> <phone-incoming-icon size="1.5x" class="custom-class"></phone-incoming-icon></a></li>
                      <li class="nav-item"><a class="nav-link" id="con4-tab" data-toggle="tab" href="#con4" role="tab" aria-controls="con4" aria-selected="false"> <phone-outgoing-icon size="1.5x" class="custom-class"></phone-outgoing-icon></a></li>
                          ...
                          <li class="active">
                            <div class="call-box">
                              ...
                              <div class="call-status">
                                <div class="icon-btn btn-outline-success button-effect btn-sm"><phone-icon size="1.5x" class="custom-class"></phone-icon></div>
                              </div>
                            </div>
                          </li>
                          <li>
                            <div class="call-box">
                              ...
                              <div class="call-status">
                                <div class="icon-btn btn-outline-success button-effect btn-sm"><video-icon size="1.5x" class="custom-class"></video-icon></div>
                              </div>
                            </div>
                          </li>
                          <li>
                            <div class="call-box">
                              ...
                              <div class="call-status">
                                <div class="icon-btn btn-outline-danger button-effect btn-sm"><phone-icon size="1.5x" class="custom-class"></phone-icon></div>
                              </div>
                            </div>
                          </li>
                          <li>
                        ...
                        <ul class="call-log-main">
                          ...
                          <li>
                            <div class="call-box">
                              ...
                              <div class="call-status">
                                <div class="icon-btn btn-outline-danger button-effect btn-sm"><video-icon size="1.5x" class="custom-class"></video-icon></div>
                              </div>
                            </div>
                          </li>
                          <li>
                    ...
                    <li>
                      <div class="contact-box">
                        ...
                        <div class="contact-action">
                          <div class="icon-btn btn-outline-primary btn-sm button-effect"><phone-icon size="1.5x" class="custom-class"></phone-icon></div>
                          <div class="icon-btn btn-outline-success btn-sm button-effect"><video-icon size="1.5x" class="custom-class"></video-icon></div>
                        </div>
                      </div>
                    </li>
                    <li class="active">
        ...
        <div class="fevorite-tab dynemic-sidebar" id="favourite">
          <div class="theme-title">
            <div class="media">
              ...
              <div class="media-body text-right">  <a class="icon-btn btn-outline-light btn-sm m-r-15 search" href="#"> <search-icon size="1.5x" class="custom-class"></search-icon></a>
                <form class="form-inline search-form">
                  <div class="form-group">
                    <input class="form-control-plaintext" type="search" placeholder="Search.."/>
                    <div class="icon-close close-search"></div>
                  </div>
                </form><a class="icon-btn btn-outline-light btn-sm m-r-15" href="#" data-toggle="modal" data-target="#addcallmodal"><plus-icon size="1.5x" class="custom-class"></plus-icon></a><a class="icon-btn btn-outline-light btn-sm close-panel"  ><x-icon size="1.5x" class="custom-class"></x-icon></a>
              </div>
            </div>
          </div>
          <ul class="chat-main">
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-primary btn-sm pull-right favourite" href="#"> <star-icon size="1.5x" class="custom-class"></star-icon></a></div>
                </div>
              </div>
            </li>
            <li>
          ...
          <div class="theme-title">
            <div class="media">
              ...
              <div class="media-body text-right">   <a class="icon-btn btn-outline-light btn-sm m-r-15 search" href="#"> <search-icon size="1.5x" class="custom-class"></search-icon></a>
                ...
                </form><a class="icon-btn btn-outline-light btn-sm close-panel"  ><x-icon size="1.5x" class="custom-class"></x-icon></a>
              </div>
            </div>
          </div>
          <ul class="chat-main">
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../assets/doc/messenger.html" target="_blank"><download-icon size="1.5x" class="custom-class"></download-icon></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../assets/doc/chapter1.MP4" target="_blank"> <download-icon size="1.5x" class="custom-class"></download-icon></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../assets/doc/salary.xlsx" target="_blank"> <download-icon size="1.5x" class="custom-class"></download-icon></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../assets/doc/document.pdf" target="_blank"> <download-icon size="1.5x" class="custom-class"></download-icon></a></div>
                </div>
              </div>
            </li>
            <li>
              <div class="chat-box">
                <div class="media">
                  ...
                  <div class="media-body"><a class="icon-btn btn-outline-light btn-sm pull-right" href="../assets/doc/details.txt" target="_blank"> <download-icon size="1.5x" class="custom-class"></download-icon></a></div>
                </div>
              </div>
            </li>
            <li>
        ...
        <div class="notification-tab dynemic-sidebar custom-scroll" id="notification">
          <div class="theme-title">
            <div class="media">
              ...
              <div class="media-body text-right">   <a class="icon-btn btn-outline-light btn-sm close-panel"  ><x-icon size="1.5x" class="custom-class"></x-icon></a></div>
            </div>
          </div>
          <ul class="chat-main">
            <li>
          ...
          <div class="setting-block">
            <div class="block">                  
              <div class="media">
                ...
                <div class="media-right"><a class="icon-btn btn-outline-light btn-sm pull-right previous" href="#"> <arrow-left-icon size="1.5x" class="custom-class"></arrow-left-icon></a></div>
              </div>
                ...
                <li>
                  <div class="media">
                    <div class="media-left"> <a class="slc" href="#"><i class="fa fa-slack"></i>
                        <h5>Slack   </h5></a></div>
                    <div class="media-right">
                      <div class="profile"><a href="https://slack.com/get-started#/" target="_blank"><plus-circle-icon size="1.5x" class="custom-class"></plus-circle-icon></a></div>
                    </div>
                  </div>
                </li>
              </ul>
          ...
          <div class="my-status-box">
            <div class="status-content">
              <div class="media">
                ...
                <div><a class="icon-btn btn-outline-light btn-sm close-panel"  ><x-icon size="1.5x" class="custom-class"></x-icon></a></div>
              </div>
            </div>
          </div>
      ...
      <div class="chitchat-main small-sidebar" id="content">
        <div class="chat-content tabto active" id="mainchatpage">
         <div class="messages custom-scroll active">
        ...
        <div class="chat-content tabto" id="startgroupchat">
          <div class="messages custom-scroll group_chat_open" >
              ...
              <div class="row">
                  ...
                  <div class="media left">
                    ...
                    <div class="media-right">
                      <ul>
                        ...
                        <li><a class="icon-btn btn-light search search-right" href="#"><search-icon size="1.5x" class="custom-class"></search-icon></a></a>
                          <form class="form-inline search-form">
                            <div class="form-group">
                              <input class="form-control-plaintext" type="search" placeholder="Search.."/>
                              <div class="icon-close close-search"> </div>
                ...
                <div class="col"> 
                  <ul class="calls text-right">
                    <li><a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Start Audio Conference" data-toggle="modal" data-target="#confercall"><phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
                    <li><a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Start Video Conference" data-toggle="modal" data-target="#confvideocl"><video-icon size="1.5x" class="custom-class"></video-icon></a></li>
              ...
              <div class="row">
                ...
                <div class="col-7">
                  <div class="media left">
                    ...
                    <div class="media-right">
                      <ul>
                        <li><a class="icon-btn btn-light button-effect mute" href="#"><i class="fa fa-volume-up"></i></a></li>
                        <li><a class="icon-btn btn-light search-right" href="#"><search-icon size="1.5x" class="custom-class"></search-icon></a></li>
                        <li><a class="icon-btn btn-light button-effect mobile-sidebar" href="#"><arrow-left-icon size="1.5x" class="custom-class"></arrow-left-icon></a></li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="col">
                  <ul class="calls text-right">
                    ...
                    <li><a class="icon-btn btn-light button-effect apps-toggle"  ><i class="ti-layout-grid2"></i></a></li>
                    <li class="chat-friend-toggle"><a class="icon-btn btn-light bg-transparent button-effect outside" href="#" data-tippy-content="Quick action"><more-vertical-icon size="1.5x" class="custom-class"></more-vertical-icon></a>
                      <div class="chat-frind-content">
                        <ul>
                          <li><a class="icon-btn btn-outline-primary button-effect btn-sm menu-trigger" href="#"><users-icon size="1.5x" class="custom-class"></users-icon></a>
              ...
              <div class="call-log-main custom-scroll">
                <div class="coll-log-group">
                  <div class="log-content-left">
                    <div class="media"><phone-incoming-icon size="1.5x" class="custom-class"></phone-incoming-icon>
                      <div class="media-body">
                        <h5>incoming call                      </h5>
                      </div>
                    </div>
          ...
          <div class="contact-profile">
            <div class="theme-title">
              <div class="media">
                ...
                <div class="media-body text-right">   <a class="icon-btn btn-outline-light btn-sm close-profile ml-3" href="#"> <x-icon size="1.5x" class="custom-class"></x-icon></a></div>
              </div>
            </div>
            <div class="details">
      ...
      <aside class="app-sidebar active" id="rightside">
              ...
              <div class="todo-main">
                <div class="theme-title">
                  <div class="media">
                    ...
                    <div class="media-body media-body text-right"><a class="icon-btn btn-sm btn-outline-light close-apps" href="javascript:void(0);" ><x-icon size="1.5x" class="custom-class"></x-icon></a></div>
                  </div>
                </div>
                <div class="todo-name">
                ...
                <div class="todo-tab theme-tab custom-scroll">
                  <ul class="nav nav-tabs">
                    ...
                    <li><a class="icon-btn btn-light button-effect btn-sm" data-toggle="modal" data-target="#todoModal"><plus-icon size="1.5x" class="custom-class"></plus-icon></a></li>
                  </ul>
              ...
              <div class="notes-main">
                ...
                <form class="default-form">
                  <div class="form-group notes-content">                    
                    ...
                    <ul>
                      <li><a class="icon-btn btn-light button-effect btn-sm" data-toggle="modal" data-target="#notesModal"><plus-icon size="1.5x" class="custom-class"></plus-icon></a></li>
                    </ul>
                  </div>
                </form>
              ...
              <div class="reminder-main">
                ...
                <div class="reminder-list-disp">
                  ...
                  <ul class="reminder-disp">
                    <li class="reminder-list-toggle"><a class="icon-btn bg-transparent" href="#"><more-vertical-icon size="1.5x" class="custom-class"></more-vertical-icon></a>
                ...
                <div class="reminder-list">
                  ...
                  <div class="target-reminder-list">
                    ...
                    <ul class="reminder-disp">
                      <li class="reminder-toggle"><a class="icon-btn bg-transparent" href="#" data-tippy-content="Quick action"><more-vertical-icon size="1.5x" class="custom-class"></more-vertical-icon></a>
        ...
        <div class="app-list">
          <ul class="app-list-ul custom-scroll">
            <li class="title apps-toggle"  id="appall"><grid-icon size="1.5x" class="custom-class"></grid-icon>
              <h5>Apps</h5>
            </li>
            <li><a class="icon-btn btn-outline-success btn-sm button-effect" href="javascript:void(0);" @click="files()"><file-icon size="1.5x" class="custom-class"></file-icon></a>
              <h5>Files    </h5>
            </li>
            <li><a class="icon-btn btn-outline-primary btn-sm button-effect" href="javascript:void(0);" @click="notes()"><book-icon size="1.5x" class="custom-class"></book-icon></a>
              <h5>Notes    </h5>
            </li>
            <li><a class="icon-btn btn-outline-danger btn-sm button-effect" href="javascript:void(0);" @click="todo()"><list-icon size="1.5x" class="custom-class"></list-icon></a>
              <h5>Todo    </h5>
            </li>
            <li><a class="icon-btn btn-outline-warning btn-sm button-effect" href="javascript:void(0);" @click="reminder()"><clock-icon size="1.5x" class="custom-class"></clock-icon></a>
              <h5>Reminder</h5>
            </li>
        ...
        <div class="modal-body">
          <div class="audiocall1 call-modal"><img class="bg-img" src="../assets/images/avtar/big/audiocall.jpg" alt="Avatar"/>
            <div class="center-con text-center">
              ...
              <ul>
                <li><a class="icon-btn btn-success button-effect btn-xl is-animating" href="#" data-toggle="modal" data-target="#audiorcvcall" data-dismiss="modal"> <phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
                <li>     <a class="icon-btn btn-danger button-effect btn-xl is-animating cancelcall" href="#" data-dismiss="modal"> <phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="videocall call-modal"><img class="bg-img" src="../assets/images/avtar/big/videocall_bg.jpg" alt="Avatar"/>
            ...
            <div class="center-con text-center">
              <ul>
                ...
                <li><a class="icon-btn btn-danger button-effect btn-xl is-animating" href="#" data-dismiss="modal" data-tippy-content="Hangup"> <phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
        ...
        <div class="modal-body">
          <div class="conferencecall call-modal"><img class="bg-img" src="../assets/images/avtar/big/audiocall.jpg" alt="Avatar"/>
            <div class="center-con text-center">
              ...
              <ul>
                <li>     <a class="icon-btn btn-danger button-effect btn-xl is-animating cancelcall" href="#" data-dismiss="modal"> <phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
                <li><a class="icon-btn btn-success button-effect btn-xl is-animating" href="#"> <video-icon size="1.5x" class="custom-class"></video-icon></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="modal-content"> 
          ...
          <div class="modal-footer clfooter">
            ...
            <ul> 
              ...
              <li><a class="icon-btn btn-danger button-effect btn-sm is-animating" href="#" data-dismiss="modal" data-tippy-content="Hangup"><phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
          ...
          <div class="audiocall2 call-modal"><img class="bg-img" src="../assets/images/avtar/big/audiocall.jpg" alt="Avatar"/>
            <div class="center-con text-center">
              ...
              <ul>
                ...
                <li><a class="icon-btn btn-danger button-effect btn-xl is-animating" href="#" data-tippy-content="Hangup" data-dismiss="modal"> <phone-icon size="1.5x" class="custom-class"></phone-icon></a></li>
                <li><a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Add Call"><i data-feather="user-plus"></i></a></li>
                ...
                <div class="call-box">
                  ...
                  <div class="call-status">
                    <div class="icon-btn btn-outline-success button-effect btn-sm">
                      <video-icon size="1.5x" class="custom-class"></video-icon></div>
                  </div>
                </div>
              </li>
              <li>
  ...
  name: 'MainComponent',
            ...
            message(){
                if(this.message.length > 0) {
                   ...
                   console.log(this.typing);
                    ...
                    console.log(this.typing);
                    this.$socket.emit('stopTyping','stoptyping');
                  }
            }
                },
   ...
   logout: function () {
      ...
      this.$router.push('/login')
       ...
       getfriends(){
            this.$http.get('https://192.168.43.78:22000/getUsers/'+this.c_user._id+'/0/5d4c07fb030f5d0600bf5c02')
      ...
      startchat(friend){
        ...
        getgroups(){
               this.$http.get('https://192.168.43.78:22000/getCreatedGroups/'+this.c_user._id+'/5d4c07fb030f5d0600bf5c02')
