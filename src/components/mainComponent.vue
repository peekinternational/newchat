...
<div class="hello">
  ...
  <div class="chitchat-container sidebar-toggle">
    ...
    <nav class="main-nav on custom-scroll" id="mainnav">
      ...
      <div class="" v-bind:class="{'dot-btn dot-danger grow' : presentersData.length > 0 }" >
          ...
          <li>
            <a class="icon-btn btn-light button-effect" href="javascript:void(0);" @click="setting()" data-intro="You can change settings by clicking here">
              <i class="fa fa-cog"></i>
            </a>
          </li>
        </ul>
        <ul class="sidebar-bottom">
          <li>
            <a class="icon-btn btn-light button-effect mode" data-tippy-content="Theme Mode" data-intro="Change mode">
          ...
          <div class="theme-tab tab-sm chat-tabs" style="padding:0px;margin-top: 50px;">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item" data-to="chat-content">
                <a class="nav-link button-effect active" id="chat-tab" data-toggle="tab" href="#chat" role="tab" aria-controls="chat" aria-selected="true" data-intro="Start chat">
                  <message-square-icon size="1.5x" class="custom-class"></message-square-icon>
                  </i>Chat</a>
              </li>
        ...
        <div class="setting-block">
          <div class="block">
            ...
            <ul class="help">
              ...
              <li>
                <h5>
                  <a class="font-danger" href="#">Delete all chats</a>
                </h5>
              </li>
            </ul>
          </div>
            ...
            <div class="row">
              ...
              <div class="col">
                <ul class="calls text-right">
                  <li>
                    <a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Start Audio Conference" data-toggle="modal" data-target="#confercall">
                      <phone-icon size="1.5x" class="custom-class"></phone-icon>
                    </a>
                  </li>
                  <li>
                    <a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Start Video Conference" data-toggle="modal" data-target="#confvideocl">
                      <video-icon size="1.5x" class="custom-class"></video-icon>
                    </a>
                  </li>
                  <li>
                  ...
                  <li class="chat-friend-toggle">
                    ...
                    <div class="chat-frind-content">
                      <ul>
                        ...
                        <li v-if=" userid == singlegroup.creatorUserId ">
                          <a class="icon-btn btn-outline-danger button-effect btn-sm" href="#" @click="deleteGroup()">
          ...
          <div class="contact-details">
            <div class="row">
              ...
              <div class="col">
                <ul class="calls text-right">
                  <li>
                    <a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Quick Audio Call" data-toggle="modal" data-target="#audiocall">
                      <phone-icon size="1.5x" class="custom-class"></phone-icon>
                    </a>
                  </li>
                  <li>
                    <a class="icon-btn btn-light button-effect" href="#" data-tippy-content="Quick Video Call" data-toggle="modal" :data-target="'#o2ovideocall'+singlefriend._id">
                      <video-icon size="1.5x" class="custom-class"></video-icon>
                    </a>
                  </li>
                  <li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="default-form">
            ...
            <div class="form-group mb-0">
              <h5> <span style="font-size:17px;cursor: pointer;" @click="showMembers()">Group Members </span>    <span style="float:right;cursor: pointer;" @click="addNewmember()">Add New Member</span></h5>
  ...
  <!---------------------------------- O2O CALL MODEL ---------------------------------->
    ...
    <div class="o2ovideocallModel  viddiolog modal fade" :id="'o2ovideocall'+singlefriend._id" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered o2omodelbefore" id="o2omodalcall" role="document">
      <div class="modal-body">
        ...
        <div class="videocall o2obeforeopenChat call-modal">
          <video id="" autoplay style="width:100%"></video>
      ...
      <div class="chat-content tabto" id="startchatsss">
        <div class=" messages custom-scroll active messageschat" id="o2ochating" style="min-height:108vh !important;">
                    ...
                    <div class="contact-name">
                      ...
                      <ul class="msg-box">
                        <li class="msg-setting-main">
                          ...
                          <h5 v-if="chat.isDeleted == 1" :id="'sendero2o'+chat._id">message deleted</h5>
                          <h5 v-else-if="chat.messageType != 1 && chat.messageType != 2 && chat.chatType == 0" :id="'sendero2o'+chat._id">{{ chat.message }}</h5>
                          <h5 v-else-if="chat.messageType != 1 && chat.messageType != 2 && chat.chatType == 1" :id="'sendero2o'+chat._id">
                            <span style="border-bottom: 1px solid;">‘‘{{chat.commentId.message}}’’</span><br> {{ chat.message }}</h5>
                          <br>
                  ...
                  <div class="media-body">
                    <div class="contact-name">
                      ...
                      <ul class="msg-box">
                        ...
                        <h5 v-if="chat.isDeleted == 1" :id="'receivero2o'+chat._id">message deleted</h5>
                          <h5 v-else-if="chat.messageType != 1 && chat.messageType != 2 && chat.chatType == 0" :id="'receiver'+chat._id">{{ chat.message }} </h5>
                          <h5 v-else-if="chat.messageType != 1 && chat.messageType != 2 && chat.chatType == 1" :id="'receivero2o'+chat._id">
                            <span style="border-bottom: 1px solid;">‘‘{{chat.commentId.message}}’’</span><br> {{ chat.message }}</h5>
                          <br>
...
mounted() {
  ...
  localStorage.setItem('userData', JSON.stringify(this.c_user));
...
/*020 video call*/
.o2ovideocallModel .modal-dialog {
  max-width: 100%;
  margin: 0px 0px 0px auto;
}
.o2ovideocallModel .modal-body {
  padding: 0;
}
.viddiolog .videocall.call-modal {
  min-height: 108vh !important;
}
.videocall.call-modal .videocall-details, .videocallhang.call-modal .o2ovideocall-details {
  position: absolute;
  top: 40px;
  padding: 35px;
  right: 0;
